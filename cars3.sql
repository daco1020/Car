...
INSERT INTO `ci_sessions` (`id`, `ip_address`, `timestamp`, `data`) VALUES
	('1', '192.0.0.0', 0, _binary ''),
	('54uhep69kgpd2eg849as311da4caqmle', '::1', 1591830602, _binary 0x5F5F63695F6C6173745F726567656E65726174657C693A313539313833303536333B73657373696F6E69647C733A333A22706F73223B757365725F69647C733A313A2231223B757365725F656D61696C7C733A31353A226F776E657240676D61696C2E636F6D223B757365725F726F6C657C733A313A2231223B);
...
CREATE TABLE IF NOT EXISTS `inventory_updated_logs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
/*!40000 ALTER TABLE `inventory_updated_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `inventory_updated_logs` ENABLE KEYS */;
...
/*!40000 ALTER TABLE `service_job_defects` DISABLE KEYS */;
/*!40000 ALTER TABLE `service_job_defects` ENABLE KEYS */;

CREATE TABLE IF NOT EXISTS `service_job_defects_material` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `service_job_id` int(11) NOT NULL,
...
/*!40000 ALTER TABLE `service_job_defects_material` DISABLE KEYS */;
/*!40000 ALTER TABLE `service_job_defects_material` ENABLE KEYS */;

CREATE TABLE IF NOT EXISTS `service_job_packages` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `service_job_id` int(11) NOT NULL,
...
/*!40000 ALTER TABLE `service_job_packages` DISABLE KEYS */;
/*!40000 ALTER TABLE `service_job_packages` ENABLE KEYS */;

CREATE TABLE IF NOT EXISTS `service_job_package_material` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `service_job_id` int(11) NOT NULL,
...
/*!40000 ALTER TABLE `service_job_package_material` DISABLE KEYS */;
/*!40000 ALTER TABLE `service_job_package_material` ENABLE KEYS */;
...
/*!40000 ALTER TABLE `service_job_payments` DISABLE KEYS */;
/*!40000 ALTER TABLE `service_job_payments` ENABLE KEYS */;

CREATE TABLE IF NOT EXISTS `service_job_status` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(499) COLLATE utf8_unicode_ci NOT NULL,
  `created_user_id` int(11) NOT NULL,
  `created_datetime` datetime NOT NULL,
...
/*!40000 ALTER TABLE `service_job_status` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `service_job_status` ENABLE KEYS */;
...
CREATE TABLE IF NOT EXISTS `service_package_tasks` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
/*!40000 ALTER TABLE `service_package_tasks` DISABLE KEYS */;
/*!40000 ALTER TABLE `service_package_tasks` ENABLE KEYS */;
